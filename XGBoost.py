...
print(np.count_nonzero(train_data_labels_xgboost == 0))
print(np.count_nonzero(train_data_labels_xgboost == 1))
print(np.count_nonzero(train_data_labels_xgboost == 2))
...
print("Accuracy: ", metrics.accuracy_score(test_data_labels_xgboost, prediction))
